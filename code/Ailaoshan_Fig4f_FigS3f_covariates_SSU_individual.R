...
# input and output file names
    ...
    filenames <- list(
        ...
        modeloutput.rds = here("rds", "Ailaoshan_model_output_final_SSU.rds"), # file containing SSU modelling results
...
# session info
writeLines(capture.output(sessionInfo()), here("sessioninfo", "Ailaoshan_Fig4f_FigS3f_covariates_SSU_individual.sessioninfo.txt"))
