...
# get data
    ...
    # SRTM data
        ailaoshan.srtm <- list()
        ailaoshan.srtm[[1]] <- raster(here("data", "gis", "srtm_data", "srtm_data/n23_e100_1arc_v3.tif"))
        ailaoshan.srtm[[2]] <- raster(here("data", "gis", "srtm_data", "srtm_data/n23_e101_1arc_v3.tif"))
        ailaoshan.srtm[[3]] <- raster(here("data", "gis", "srtm_data", "srtm_data/n24_e100_1arc_v3.tif"))
        ailaoshan.srtm[[4]] <- raster(here("data", "gis", "srtm_data", "srtm_data/n24_e101_1arc_v3.tif"))
        ailaoshan.srtm[[5]] <- raster(here("data", "gis", "srtm_data", "srtm_data/n25_e100_1arc_v3.tif"))
        ailaoshan.srtm[[6]] <- raster(here("data", "gis", "srtm_data", "srtm_data/n25_e101_1arc_v3.tif"))
...
# session info
writeLines(capture.output(sessionInfo()), here("sessioninfo", "Ailaoshan_gis.sessioninfo.txt"))
