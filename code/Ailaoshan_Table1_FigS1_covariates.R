# R code to generate Table 1 and Fig S1 to show environmental covariates
...
# Table 1 in manuscript
    ...
    write_csv(env.summary, path = here("tables", "Table1_environmental_covariates_summary.csv"))

# session info
writeLines(capture.output(sessionInfo()), here("sessioninfo", "Ailaoshan_Table1_FigS1_covariates.sessioninfo.txt"))
