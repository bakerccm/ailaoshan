...
# input and output file names
    ...
    filenames <- list(
        ...
        modeldata.SSU.rdata = here("rdata", "Ailaoshan_model_data_final_SSU.rdata"), # rdata file containing data for SSU model
        modeldata.both.rdata = here("rdata", "Ailaoshan_model_data_final.rdata"), # rdata file containing data for both LSU and SSU models

        modeloutput.rds = here("rds", "Ailaoshan_model_output_final_SSU.rds"), # file containing modelling results
...
# session info
writeLines(capture.output(sessionInfo()), here("sessioninfo", "Ailaoshan_Fig4e_FigS3e_covariates_SSU_community.sessioninfo.txt"))
