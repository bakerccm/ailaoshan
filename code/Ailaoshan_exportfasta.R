...
#  write seqeunces to FASTA

    ## LSU ##

        LSU.filename <- here("fasta", "FileS3_LSU_representative_sequences.fasta")
    ...
    ## SSU ##
        ...
        SSU.filename <- here("fasta", "FileS4_SSU_representative_sequences.fasta")
...
# session info
writeLines(capture.output(sessionInfo()), here("sessioninfo", "Ailaoshan_exportfasta.sessioninfo.txt"))
